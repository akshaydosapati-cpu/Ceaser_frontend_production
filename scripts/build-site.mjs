...
for (const file of ["style.css", "animations.js", "verify.css", "verify.js", "privacy.html", "terms.html", "security.html", "launching-soon.html", "favicon.png", "ceaser-wordmark.png", "ceaser-logo-full.png", "sitemap.xml", "robots.txt"]) {
...
await mkdir(path.join(output, "verify"), { recursive: true })
await cp(path.join(root, "verify.html"), path.join(output, "verify", "index.html"))
